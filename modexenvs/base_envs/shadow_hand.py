...
class ShadowHand(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        for i in range(self.num_shadow_hand_dofs):
            ...
            shadow_hand_dof_props['velocity'][i] = 0.5
        ...
        #     # camera_position = gymapi.Vec3(.5, -.5, 1.)
        #     camera_position = gymapi.Vec3(0, -.5, 1.)
        #     camera_target = gymapi.Vec3(0, -.2, 0.5)
