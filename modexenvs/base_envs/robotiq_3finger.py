...
class Robotiq3Finger(VecTask):
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture: bool = False, force_render: bool = False):
        ...
        #     "full_state": 88
        # }
        self.fingertips = ["gripper_fingerA_dist", "gripper_fingerB_dist", "gripper_fingerC_dist"]
        self.num_fingertips = len(self.fingertips)
        self.tip_offset = [0, 0, 0.02]
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        allegro_hand_asset_file = "urdf/robotiq_3finger/robots/movable_robotiq_3finger.urdf"
        ...
        #     camera_position = gymapi.Vec3(.5, -.5, .75)
