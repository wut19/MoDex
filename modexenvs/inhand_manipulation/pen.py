...
class PenTwirlFixedEnvV0(BaseV0):
    ...
    # DEFAULT_OBS_KEYS = ['hand_jnt', 'tip_pos', 'obj_pos', 'obj_vel', 'obj_rot', 'obj_des_rot', 'obj_err_pos', 'obj_err_rot']
    DEFAULT_OBS_KEYS = ['tip_pos', 'obj_pos', 'obj_rot', 'obj_err_pos', 'obj_err_rot']
    ...
    def _setup(self,
        ...
        self.observation_space = gym.spaces.Box((-10)*np.ones(66), 10*np.ones(66), dtype=np.float32)
