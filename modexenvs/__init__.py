...
import os
from .base_envs.allegro import AllegroHand
from .base_envs.shadow_hand import ShadowHand
from .base_envs.robotiq_3finger import Robotiq3Finger
from .base_envs.myohand import MyoHand

isaacgym_task_mapping = {
    "AllegroHand": AllegroHand,
    "ShadowHand": ShadowHand,
    "Robotiq3Finger": Robotiq3Finger,
}
...
def get_rlgames_env_creator(
    ...
    def create_rlgpu_env():
        ...
        env = isaacgym_task_mapping[task_name](
            cfg=task_config,
