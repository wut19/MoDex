...
class AgentLLM:
    def __init__(self, name: str, model_engine = "gpt-4", save_path ="./LLM/log/"):
        self._name = name
...
if __name__ == "__main__":
    agent = AgentLLM("test")
    agent.load_system_prompt_from_file('LLM/system_prompt.txt')
    prompt = 'Can you generate peace gesture?'
